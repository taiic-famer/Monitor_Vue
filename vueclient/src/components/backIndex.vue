<template>
  <div class="backlogin">
    ...
    <div class="sidenav_box">
      ...
      <ul class="sidenav">
        <li class="now">
          <router-link to="/backIndex/stationData">
            <i class="fa fa-home" aria-hidden="true"></i>
            <span>飞行数据</span>
          </router-link>
        </li>
        <li>
          <router-link to="/backIndex/stationPlan">
        ...
        <li>
          <router-link to="/backIndex/planeList">
            <i class="fa fa-user-circle-o" aria-hidden="trmissionue"></i>
            <span>无人机管理</span>
          </router-link>
        </li>
        <li>
          <router-link to="/backIndex/missionList">
            <i class="fa fa-book" aria-hidden="true"></i>
            <span>任务管理</span>
          </router-link>
        </li>
        <li>
          <router-link to="/backIndex/mqtt">
            <i class="fa fa-book" aria-hidden="true"></i>
            <span>mqtt</span>
          </router-link>
        </li>
...
export default {
  ...
  watch: {
    //监控路径变化  当路径发送变化的时候，改变面包屑导航的显示
    $route: {
      handler: function (val, oldVal) {
        var path = val.path;
        this.pageTitle =
          pageTitleObj[path.substr(path.lastIndexOf("/") + 1)] || "网站首页";
      },
    },
  },
};
