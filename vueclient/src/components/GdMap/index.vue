...
export default {
  ...
  methods: {
    changePosition(){
      this.position.splice(0, 1, 117.738)
    },
    mqttMsg() {
      client.on('connect', (e) => {
        console.log('接收连接成功！！！')
    ...
    init() {
      ...
      map.on('click', function (e) {
        ...
        //   text:
        //     'http://192.168.61.31:5501/examples/webgl_animation_skinning_morph.html',
        //   anchor: 'center',
        //   draggable: true,
        //   cursor: 'pointer',
      ...
      map.plugin(['AMap.GltfLoader'], function () {
        ...
        // var urlDuck = "/public/models/Duck.gltf";
        // var urlDuck =
        //   'file:///C:/Users/张立旺/Desktop/code/vue-admin-template/src/components/Station/GdMap/Duck.gltf'
